...
import {FaInstagram,FaLinkedin, FaLinkedinIn, FaTwitter, FaX, FaXTwitter} from "react-icons/fa6"

const Footer = () => {
  return (
    <footer className='h-96 lg:h-60 xl:-48 bg-gradient-to-t from-slate-900 to-black px-40 border-t border-t-blue-500'>
        ...
        <div className='container flex flex-col justify-end lg:flex-row mt-3'>
            ...
            <div className='basis-1/3 flex pr-20 sm:pr-0 lg:pl-10 pt-2 justify-center'>
                <a href='#' className='flex hover:scale-110 duration-1000'>
                    ...
                    <h2 className='pl-2 pt-3 xl:text-xl text-white font-bold whitespace-nowrap'>MASA</h2>
                </a>
            </div>
            {/* MID */}
            <div className='basis-1/3 flex justify-center pt-3'>
                <ul className='px-4'>
                    <li className='text-white hover:text-slate-400 font-semibold cursor-pointer font-sociology2'>Home</li>
                    <li className='text-white hover:text-slate-400 font-semibold cursor-pointer font-sociology2'>About</li>
                    <li className='text-white hover:text-slate-400 font-semibold cursor-pointer font-sociology2'>Contact</li>
                </ul>
            </div>
            {/* RIGHT */}
        ...
        <div className='flex justify-center items-center pt-10'>
            <p className='text-white font-semibold whitespace-nowrap font-sociology1'>2023 Dogukan Basaran No &copy; Copyright.</p>
        </div>
